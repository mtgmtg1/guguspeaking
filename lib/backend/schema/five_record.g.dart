...
part of 'five_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<FiveRecord> _$fiveRecordSerializer = new _$FiveRecordSerializer();

class _$FiveRecordSerializer implements StructuredSerializer<FiveRecord> {
  @override
  final Iterable<Type> types = const [FiveRecord, _$FiveRecord];
  @override
  final String wireName = 'FiveRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, FiveRecord object,
  ...
  @override
  FiveRecord deserialize(Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new FiveRecordBuilder();
...
class _$FiveRecord extends FiveRecord {
  @override
  ...
  factory _$FiveRecord([void Function(FiveRecordBuilder)? updates]) =>
      (new FiveRecordBuilder()..update(updates))._build();
  ...
  @override
  FiveRecord rebuild(void Function(FiveRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  FiveRecordBuilder toBuilder() => new FiveRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is FiveRecord &&
        one == other.one &&
        two == other.two &&
        three == other.three &&
        four == other.four &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'FiveRecord')
          ..add('one', one)
          ..add('two', two)
          ..add('three', three)
          ..add('four', four)
...
class FiveRecordBuilder implements Builder<FiveRecord, FiveRecordBuilder> {
  _$FiveRecord? _$v;
  ...
  FiveRecordBuilder() {
    FiveRecord._initializeBuilder(this);
  }

  FiveRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(FiveRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$FiveRecord;
  }

  @override
  void update(void Function(FiveRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  FiveRecord build() => _build();

  _$FiveRecord _build() {
    _$FiveRecord _$result;
    try {
      _$result = _$v ??
          new _$FiveRecord._(
              one: _one?.build(),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'FiveRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
