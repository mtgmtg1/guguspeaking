...
part of 'six_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<SixRecord> _$sixRecordSerializer = new _$SixRecordSerializer();

class _$SixRecordSerializer implements StructuredSerializer<SixRecord> {
  @override
  final Iterable<Type> types = const [SixRecord, _$SixRecord];
  @override
  final String wireName = 'SixRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, SixRecord object,
  ...
  @override
  SixRecord deserialize(Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new SixRecordBuilder();
...
class _$SixRecord extends SixRecord {
  @override
  ...
  factory _$SixRecord([void Function(SixRecordBuilder)? updates]) =>
      (new SixRecordBuilder()..update(updates))._build();
  ...
  @override
  SixRecord rebuild(void Function(SixRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SixRecordBuilder toBuilder() => new SixRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SixRecord &&
        one == other.one &&
        two == other.two &&
        three == other.three &&
        four == other.four &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SixRecord')
          ..add('one', one)
          ..add('two', two)
          ..add('three', three)
          ..add('four', four)
...
class SixRecordBuilder implements Builder<SixRecord, SixRecordBuilder> {
  _$SixRecord? _$v;
  ...
  SixRecordBuilder() {
    SixRecord._initializeBuilder(this);
  }

  SixRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(SixRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$SixRecord;
  }

  @override
  void update(void Function(SixRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SixRecord build() => _build();

  _$SixRecord _build() {
    _$SixRecord _$result;
    try {
      _$result = _$v ??
          new _$SixRecord._(
              one: _one?.build(),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'SixRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
