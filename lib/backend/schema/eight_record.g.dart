...
part of 'eight_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<EightRecord> _$eightRecordSerializer = new _$EightRecordSerializer();

class _$EightRecordSerializer implements StructuredSerializer<EightRecord> {
  @override
  final Iterable<Type> types = const [EightRecord, _$EightRecord];
  @override
  final String wireName = 'EightRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, EightRecord object,
  ...
  @override
  EightRecord deserialize(Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new EightRecordBuilder();
...
class _$EightRecord extends EightRecord {
  @override
  ...
  factory _$EightRecord([void Function(EightRecordBuilder)? updates]) =>
      (new EightRecordBuilder()..update(updates))._build();
  ...
  @override
  EightRecord rebuild(void Function(EightRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  EightRecordBuilder toBuilder() => new EightRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is EightRecord &&
        one == other.one &&
        two == other.two &&
        three == other.three &&
        four == other.four &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'EightRecord')
          ..add('one', one)
          ..add('two', two)
          ..add('three', three)
          ..add('four', four)
...
class EightRecordBuilder implements Builder<EightRecord, EightRecordBuilder> {
  _$EightRecord? _$v;
  ...
  EightRecordBuilder() {
    EightRecord._initializeBuilder(this);
  }

  EightRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(EightRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$EightRecord;
  }

  @override
  void update(void Function(EightRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  EightRecord build() => _build();

  _$EightRecord _build() {
    _$EightRecord _$result;
    try {
      _$result = _$v ??
          new _$EightRecord._(
              one: _one?.build(),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'EightRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
