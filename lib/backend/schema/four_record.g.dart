...
part of 'four_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<FourRecord> _$fourRecordSerializer = new _$FourRecordSerializer();

class _$FourRecordSerializer implements StructuredSerializer<FourRecord> {
  @override
  final Iterable<Type> types = const [FourRecord, _$FourRecord];
  @override
  final String wireName = 'FourRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, FourRecord object,
  ...
  @override
  FourRecord deserialize(Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new FourRecordBuilder();
...
class _$FourRecord extends FourRecord {
  @override
  ...
  factory _$FourRecord([void Function(FourRecordBuilder)? updates]) =>
      (new FourRecordBuilder()..update(updates))._build();
  ...
  @override
  FourRecord rebuild(void Function(FourRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  FourRecordBuilder toBuilder() => new FourRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is FourRecord &&
        one == other.one &&
        two == other.two &&
        three == other.three &&
        four == other.four &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'FourRecord')
          ..add('one', one)
          ..add('two', two)
          ..add('three', three)
          ..add('four', four)
...
class FourRecordBuilder implements Builder<FourRecord, FourRecordBuilder> {
  _$FourRecord? _$v;
  ...
  FourRecordBuilder() {
    FourRecord._initializeBuilder(this);
  }

  FourRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(FourRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$FourRecord;
  }

  @override
  void update(void Function(FourRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  FourRecord build() => _build();

  _$FourRecord _build() {
    _$FourRecord _$result;
    try {
      _$result = _$v ??
          new _$FourRecord._(
              one: _one?.build(),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'FourRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
