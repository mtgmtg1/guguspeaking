...
part of 'two_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<TwoRecord> _$twoRecordSerializer = new _$TwoRecordSerializer();

class _$TwoRecordSerializer implements StructuredSerializer<TwoRecord> {
  @override
  final Iterable<Type> types = const [TwoRecord, _$TwoRecord];
  @override
  final String wireName = 'TwoRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, TwoRecord object,
  ...
  @override
  TwoRecord deserialize(Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new TwoRecordBuilder();
...
class _$TwoRecord extends TwoRecord {
  @override
  ...
  factory _$TwoRecord([void Function(TwoRecordBuilder)? updates]) =>
      (new TwoRecordBuilder()..update(updates))._build();
  ...
  @override
  TwoRecord rebuild(void Function(TwoRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  TwoRecordBuilder toBuilder() => new TwoRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is TwoRecord &&
        one == other.one &&
        two == other.two &&
        three == other.three &&
        four == other.four &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'TwoRecord')
          ..add('one', one)
          ..add('two', two)
          ..add('three', three)
          ..add('four', four)
...
class TwoRecordBuilder implements Builder<TwoRecord, TwoRecordBuilder> {
  _$TwoRecord? _$v;
  ...
  TwoRecordBuilder() {
    TwoRecord._initializeBuilder(this);
  }

  TwoRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(TwoRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$TwoRecord;
  }

  @override
  void update(void Function(TwoRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  TwoRecord build() => _build();

  _$TwoRecord _build() {
    _$TwoRecord _$result;
    try {
      _$result = _$v ??
          new _$TwoRecord._(
              one: _one?.build(),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'TwoRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
