...
part of 'seven_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<SevenRecord> _$sevenRecordSerializer = new _$SevenRecordSerializer();

class _$SevenRecordSerializer implements StructuredSerializer<SevenRecord> {
  @override
  final Iterable<Type> types = const [SevenRecord, _$SevenRecord];
  @override
  final String wireName = 'SevenRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, SevenRecord object,
  ...
  @override
  SevenRecord deserialize(Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new SevenRecordBuilder();
...
class _$SevenRecord extends SevenRecord {
  @override
  ...
  factory _$SevenRecord([void Function(SevenRecordBuilder)? updates]) =>
      (new SevenRecordBuilder()..update(updates))._build();
  ...
  @override
  SevenRecord rebuild(void Function(SevenRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SevenRecordBuilder toBuilder() => new SevenRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SevenRecord &&
        one == other.one &&
        two == other.two &&
        three == other.three &&
        four == other.four &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SevenRecord')
          ..add('one', one)
          ..add('two', two)
          ..add('three', three)
          ..add('four', four)
...
class SevenRecordBuilder implements Builder<SevenRecord, SevenRecordBuilder> {
  _$SevenRecord? _$v;
  ...
  SevenRecordBuilder() {
    SevenRecord._initializeBuilder(this);
  }

  SevenRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(SevenRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$SevenRecord;
  }

  @override
  void update(void Function(SevenRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SevenRecord build() => _build();

  _$SevenRecord _build() {
    _$SevenRecord _$result;
    try {
      _$result = _$v ??
          new _$SevenRecord._(
              one: _one?.build(),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'SevenRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
